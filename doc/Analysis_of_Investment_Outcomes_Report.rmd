...
```{r fre-dist-plots, out.width="110", fig.align="center", fig.cap="Frequency Distributions of the chosen variables"}
...
```{python final-score}
finalscore = pickle.load("../result/final_score")
```


#### Testing Score

The model shows an accuracy of `py$finalscore` percent on the testing data, which is very slightly better than arbitrary guessing.
...
```{r plot-1, fig.align="center", out.width="80%", fig.cap="Plot 1"}
knitr::include_graphics("../result/plot1.png")
```

```{r plot-2, fig.align="center", out.width="80%", fig.cap="Plot 2"}
knitr::include_graphics("../result/plot2.png")
```

```{r plot-3, fig.align="center", out.width="80%", fig.cap="Plot 3"}
knitr::include_graphics("../result/plot3.png")
```

```{r plot-4, fig.align="center", out.width="80%", fig.cap="Plot 4"}
