...
```{r data}
 ...
 first_5 = data.head()
knitr::kable(first_5, caption = "The CIS Dataset (first 5)")
```
...
```{r fre-dist-plots, out.width="50%", fig.cap="Frequency Distributions of the chosen variables"}
...
```{r corr-mat, out.width="50%", fig.cap="Matrix of correlations between various features"}
...
```{r cv-plot, out.width="50%", fig.cap="Cross Validation Accuracy vs Fold Iterations"}
...
```{r elbow-plot, out.width="50%", fig.cap="Elbow plot of K-values vs CV accuracy"}
...
```{r conf-mat, out.width="50%", fig.cap="Confusion Matrix"}
